...
We will also use a database of major Ozarkian springs surveyed by Julian Steyermark in the 1920s-2030s. You can obtain it from [www.earthSkySea.org/!ecology/data/steyermarkSprings.zip](www.earthSkySea.org/!ecology/data/steyermarkSprings.zip). Unzip this and load it into `R` as a data frame.
...
But we can also save it in "shapefile" format for importing into a GIS program like ArcMap or QGIS:
```{r, eval=FALSE}
